...
//           <img className="logo" src="https://chrislowe-takor.github.io/react-leaflet-distortable-imageoverlay/soar_logo.png" alt=""></img>
...
//           <button className={this.state.editMode === 'rotate' ? 'btn enabled' : 'btn' } href="#" onClick={this.clickRotate.bind(this)}><i className="fa fa-refresh"></i><span className="tool-text">Rotate</span></button>
//           <button className={this.state.editMode === 'distort' ? 'btn enabled' : 'btn' } href="#" onClick={this.clickDistort.bind(this)}><i className="fa fa-object-group"></i><span className="tool-text">Distort</span></button>
//           <button className={this.state.editMode === 'translate' ? 'btn enabled' : 'btn' } href="#" onClick={this.clickTranslate.bind(this)}><i className="fa fa-arrows"></i><span className="tool-text">Translate</span></button>
//           <button className={this.state.editMode === 'scale' ? 'btn enabled' : 'btn' } href="#" onClick={this.clickScale.bind(this)}><i className="fa fa-expand"></i><span className="tool-text">Scale</span></button>
//           <button className="btn" href="#" onClick={this.clickClose.bind(this)}><i className="fa fa-lock"></i><span className="tool-text">Lock</span></button>
